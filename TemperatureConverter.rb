...
begin 
	...
	unless currentTempChoice[0] == "Q"
		...
		print "\nAnd which temperature would you like to convert that too(also see list above, default fahrenheit is chosen if a correct one isn't given)?: "
	...
	end#End of not 'q' unless/if statement(outter)
